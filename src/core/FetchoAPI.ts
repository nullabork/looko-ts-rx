...
// import { QueryActions, TransformActions } from './Transforms.enum';
...
//     DataHash: string;
//     filter: string;
//     cb: {(body:Array<IResource>, response?:string): void;}
// }
...
// export interface ITransformSpecific extends IRequest  {
//     AccessKeyID: string;
//     Action: TransformActions;
//     Results?: Array<{
//         UriHash: string;
...
//     public static specificTransform(props : ITransformSpecific) {
//         let endpoint = `${Config.api}/accesskeys`;
...
//     public static getResoures( props : IGetResource ) {
        
//         var GetOpts = {
//             method: 'GET',
//             uri: `${Config.api}/resources/${props.DataHash}/text?filter=${props.filter}`,
//             json: true
//         };

//         rp(GetOpts)
//             .then((body : Array<IResource>) => {
//                 props.cb(body, "200");
//             })
//             .catch((err : any) => {
//             });
